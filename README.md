...
It includes quick training controls for each side, a continuous joint-training toggle, a footer switch for the shared dashboard brand theme, duel evaluation batches, a live watch mode, and a simple duel-margin chart so you can track whether Evolution or RL is winning more often across repeated matches.
